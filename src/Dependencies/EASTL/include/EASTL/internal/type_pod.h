...
namespace eastl
{
	...
	///////////////////////////////////////////////////////////////////////
		...
		template <typename T> 
		struct has_trivial_assign : public integral_constant<bool, (__is_trivially_assignable(T) || eastl::is_pod<T>::value) && !eastl::is_const<T>::value && !eastl::is_volatile<T>::value>{};
	#else
	...
	///////////////////////////////////////////////////////////////////////
		...
		template <typename T> 
		struct has_nothrow_assign : public eastl::integral_constant<bool, __is_nothrow_assignable(T)>{};
