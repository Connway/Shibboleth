...
filter { "configurations:Debug", "platforms:x64 or arm64" }
	defines { "TARGET_SUFFIX_U8=\"64d\"", "TARGET_SUFFIX=\"64d\"" }
	targetsuffix "64d"

filter { "configurations:Release", "platforms:x64 or arm64" }
	defines { "TARGET_SUFFIX_U8=\"64\"", "TARGET_SUFFIX=\"64\"" }
	targetsuffix "64"

filter { "configurations:Profile", "platforms:x64 or arm64" }
	defines { "TARGET_SUFFIX_U8=\"64p\"", "TARGET_SUFFIX=\"64p\"" }
	targetsuffix "64p"

filter { "configurations:Optimized_Debug", "platforms:x64 or arm64" }
	defines { "TARGET_SUFFIX_U8=\"64od\"", "TARGET_SUFFIX=\"64od\"" }
	targetsuffix "64od"

filter { "configurations:Static_Debug*", "platforms:x64 or arm64" }
	defines { "TARGET_SUFFIX_U8=\"64sd\"", "TARGET_SUFFIX=\"64sd\"" }
	targetsuffix "64sd"

filter { "configurations:Static_Release*", "platforms:x64 or arm64" }
