...
ifeq ($(config),debug_x64)
  ...
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Debug/Resource
...
ifeq ($(config),release_x64)
  ...
  TARGET = $(TARGETDIR)/Resource.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Release/Resource
...
ifeq ($(config),debug_clang_x64)
  ...
  TARGET = $(TARGETDIR)/Resource.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Debug_Clang/Resource
  DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
  INCLUDES += -I../../../../../src/Modules/Resource/include -I../../../../../src/Engine/Memory/include -I../../../../../src/Engine/Engine/include -I../../../../../src/Dependencies/EASTL/include -I../../../../../src/Frameworks/Gaff/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_clang_x64)
  ...
  TARGET = $(TARGETDIR)/Resource.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Release_Clang/Resource
  DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -DNDEBUG -DWIN32 -D_WINDOWS -DWIN64
  INCLUDES += -I../../../../../src/Modules/Resource/include -I../../../../../src/Engine/Memory/include -I../../../../../src/Engine/Engine/include -I../../../../../src/Dependencies/EASTL/include -I../../../../../src/Frameworks/Gaff/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),profile_x64)
  ...
  TARGET = $(TARGETDIR)/Resource.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Profile/Resource
...
ifeq ($(config),profile_clang_x64)
  ...
  TARGET = $(TARGETDIR)/Resource.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Profile_Clang/Resource
  DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -DNDEBUG -DWIN32 -D_WINDOWS -DWIN64
  INCLUDES += -I../../../../../src/Modules/Resource/include -I../../../../../src/Engine/Memory/include -I../../../../../src/Engine/Engine/include -I../../../../../src/Dependencies/EASTL/include -I../../../../../src/Frameworks/Gaff/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),optimized_debug_x64)
  ...
  TARGET = $(TARGETDIR)/Resource.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Optimized_Debug/Resource
  DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
  INCLUDES += -I../../../../../src/Modules/Resource/include -I../../../../../src/Engine/Memory/include -I../../../../../src/Engine/Engine/include -I../../../../../src/Dependencies/EASTL/include -I../../../../../src/Frameworks/Gaff/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),optimized_debug_clang_x64)
  ...
  TARGET = $(TARGETDIR)/Resource.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Optimized_Debug_Clang/Resource
  DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
  INCLUDES += -I../../../../../src/Modules/Resource/include -I../../../../../src/Engine/Memory/include -I../../../../../src/Engine/Engine/include -I../../../../../src/Dependencies/EASTL/include -I../../../../../src/Frameworks/Gaff/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
OBJECTS := \
	$(OBJDIR)/Shibboleth_IResource.o \
	$(OBJDIR)/Shibboleth_ResourceExtensionAttribute.o \
	$(OBJDIR)/Shibboleth_ResourceManager.o \
