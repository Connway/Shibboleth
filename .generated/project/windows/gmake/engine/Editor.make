...
ifeq ($(config),debug_x64)
  ...
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Debug/Editor
...
ifeq ($(config),release_x64)
  ...
  TARGET = $(TARGETDIR)/Editor.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Release/Editor
...
ifeq ($(config),debug_clang_x64)
  ...
  TARGET = $(TARGETDIR)/Editor.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Debug_Clang/Editor
  DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
  INCLUDES += -I../../../../../src/Engine/Editor/include -I../../../../../src/Engine/Engine/include -I../../../../../src/Engine/Memory/include -I../../../../../src/Frameworks/Gaff/include -I../../../../../src/Dependencies/EASTL/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_clang_x64)
  ...
  TARGET = $(TARGETDIR)/Editor.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Release_Clang/Editor
  DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -DNDEBUG -DWIN32 -D_WINDOWS -DWIN64
  INCLUDES += -I../../../../../src/Engine/Editor/include -I../../../../../src/Engine/Engine/include -I../../../../../src/Engine/Memory/include -I../../../../../src/Frameworks/Gaff/include -I../../../../../src/Dependencies/EASTL/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),profile_x64)
  ...
  TARGET = $(TARGETDIR)/Editor.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Profile/Editor
...
ifeq ($(config),profile_clang_x64)
  ...
  TARGET = $(TARGETDIR)/Editor.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Profile_Clang/Editor
  DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -DNDEBUG -DWIN32 -D_WINDOWS -DWIN64
  INCLUDES += -I../../../../../src/Engine/Editor/include -I../../../../../src/Engine/Engine/include -I../../../../../src/Engine/Memory/include -I../../../../../src/Frameworks/Gaff/include -I../../../../../src/Dependencies/EASTL/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),optimized_debug_x64)
  ...
  TARGET = $(TARGETDIR)/Editor.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Optimized_Debug/Editor
  DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
  INCLUDES += -I../../../../../src/Engine/Editor/include -I../../../../../src/Engine/Engine/include -I../../../../../src/Engine/Memory/include -I../../../../../src/Frameworks/Gaff/include -I../../../../../src/Dependencies/EASTL/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),optimized_debug_clang_x64)
  ...
  TARGET = $(TARGETDIR)/Editor.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Optimized_Debug_Clang/Editor
  DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
  INCLUDES += -I../../../../../src/Engine/Editor/include -I../../../../../src/Engine/Engine/include -I../../../../../src/Engine/Memory/include -I../../../../../src/Frameworks/Gaff/include -I../../../../../src/Dependencies/EASTL/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
OBJECTS := \
	$(OBJDIR)/Shibboleth_EditorFileHandlerAttribute.o \
	$(OBJDIR)/Shibboleth_EditorFileSelectedMessage.o \
	$(OBJDIR)/Shibboleth_EditorWindowAttribute.o \
