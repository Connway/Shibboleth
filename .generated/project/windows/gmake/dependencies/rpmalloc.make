...
ifeq ($(config),debug_x64)
  ...
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Debug/rpmalloc
...
ifeq ($(config),release_x64)
  ...
  TARGET = $(TARGETDIR)/rpmalloc.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Release/rpmalloc
...
ifeq ($(config),debug_clang_x64)
  ...
  TARGET = $(TARGETDIR)/rpmalloc.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Debug_Clang/rpmalloc
  DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release_clang_x64)
  ...
  TARGET = $(TARGETDIR)/rpmalloc.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Release_Clang/rpmalloc
  DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -DNDEBUG -DWIN32 -D_WINDOWS -DWIN64
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),profile_x64)
  ...
  TARGET = $(TARGETDIR)/rpmalloc.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Profile/rpmalloc
...
ifeq ($(config),profile_clang_x64)
  ...
  TARGET = $(TARGETDIR)/rpmalloc.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Profile_Clang/rpmalloc
  DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -DNDEBUG -DWIN32 -D_WINDOWS -DWIN64
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),optimized_debug_x64)
  ...
  TARGET = $(TARGETDIR)/rpmalloc.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Optimized_Debug/rpmalloc
  DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),optimized_debug_clang_x64)
  ...
  TARGET = $(TARGETDIR)/rpmalloc.lib
  OBJDIR = ../../../../build/windows/gmake/intermediate/x64/Optimized_Debug_Clang/rpmalloc
  DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
  INCLUDES +=
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
