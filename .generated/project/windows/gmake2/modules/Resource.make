...
INCLUDES += -I../../../../../src/Modules/Resource/include -I../../../../../src/Engine/Memory/include -I../../../../../src/Engine/Engine/include -I../../../../../src/Dependencies/EASTL/include -I../../../../../src/Frameworks/Gaff/include
FORCE_INCLUDE +=
...
TARGET = $(TARGETDIR)/Resource.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Debug/Resource
...
TARGET = $(TARGETDIR)/Resource.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Release/Resource
...
TARGET = $(TARGETDIR)/Resource.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Debug_Clang/Resource
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
...
TARGET = $(TARGETDIR)/Resource.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Release_Clang/Resource
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -DNDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
TARGET = $(TARGETDIR)/Resource.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Profile/Resource
...
TARGET = $(TARGETDIR)/Resource.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Profile_Clang/Resource
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -DNDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
TARGET = $(TARGETDIR)/Resource.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Optimized_Debug/Resource
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
TARGET = $(TARGETDIR)/Resource.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Optimized_Debug_Clang/Resource
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
OBJECTS += $(OBJDIR)/Shibboleth_IResource.o
OBJECTS += $(OBJDIR)/Shibboleth_ResourceExtensionAttribute.o
OBJECTS += $(OBJDIR)/Shibboleth_ResourceManager.o
...
$(OBJDIR)/Shibboleth_IResource.o: ../../../../../src/Modules/Resource/Shibboleth_IResource.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/Shibboleth_ResourceExtensionAttribute.o: ../../../../../src/Modules/Resource/Shibboleth_ResourceExtensionAttribute.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/Shibboleth_ResourceManager.o: ../../../../../src/Modules/Resource/Shibboleth_ResourceManager.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
