...
TARGET = $(TARGETDIR)/Entity.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Debug/Entity
...
TARGET = $(TARGETDIR)/Entity.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Release/Entity
...
TARGET = $(TARGETDIR)/Entity.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Debug_Clang/Entity
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
...
TARGET = $(TARGETDIR)/Entity.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Release_Clang/Entity
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -DNDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
TARGET = $(TARGETDIR)/Entity.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Profile/Entity
...
TARGET = $(TARGETDIR)/Entity.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Profile_Clang/Entity
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -DNDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
TARGET = $(TARGETDIR)/Entity.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Optimized_Debug/Entity
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
TARGET = $(TARGETDIR)/Entity.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Optimized_Debug_Clang/Entity
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
OBJECTS += $(OBJDIR)/Shibboleth_Component.o
OBJECTS += $(OBJDIR)/Shibboleth_Object.o
OBJECTS += $(OBJDIR)/Shibboleth_ObjectManager.o
OBJECTS += $(OBJDIR)/Shibboleth_PrefabResource.o
...
$(OBJDIR)/Shibboleth_Component.o: ../../../../../src/Modules/Entity/Shibboleth_Component.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/Shibboleth_Object.o: ../../../../../src/Modules/Entity/Shibboleth_Object.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/Shibboleth_ObjectManager.o: ../../../../../src/Modules/Entity/Shibboleth_ObjectManager.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/Shibboleth_PrefabResource.o: ../../../../../src/Modules/Entity/Shibboleth_PrefabResource.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
