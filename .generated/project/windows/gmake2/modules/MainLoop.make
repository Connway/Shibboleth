...
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Debug/MainLoop
...
TARGET = $(TARGETDIR)/MainLoop.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Release/MainLoop
...
TARGET = $(TARGETDIR)/MainLoop.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Debug_Clang/MainLoop
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
...
TARGET = $(TARGETDIR)/MainLoop.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Release_Clang/MainLoop
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -DNDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
TARGET = $(TARGETDIR)/MainLoop.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Profile/MainLoop
...
TARGET = $(TARGETDIR)/MainLoop.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Profile_Clang/MainLoop
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -DNDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
TARGET = $(TARGETDIR)/MainLoop.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Optimized_Debug/MainLoop
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
TARGET = $(TARGETDIR)/MainLoop.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Optimized_Debug_Clang/MainLoop
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
OBJECTS += $(OBJDIR)/Shibboleth_MainLoop.o
OBJECTS += $(OBJDIR)/Shibboleth_SetupFunctions.o
