...
TARGET = $(TARGETDIR)/rpmalloc.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Debug/rpmalloc
...
TARGET = $(TARGETDIR)/rpmalloc.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Release/rpmalloc
...
TARGET = $(TARGETDIR)/rpmalloc.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Debug_Clang/rpmalloc
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
...
TARGET = $(TARGETDIR)/rpmalloc.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Release_Clang/rpmalloc
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -DNDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -ffast-math -O3 -g
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -ffast-math -O3 -g -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
TARGET = $(TARGETDIR)/rpmalloc.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Profile/rpmalloc
...
TARGET = $(TARGETDIR)/rpmalloc.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Profile_Clang/rpmalloc
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -DNDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -ffast-math -O3 -g
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -ffast-math -O3 -g -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
TARGET = $(TARGETDIR)/rpmalloc.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Optimized_Debug/rpmalloc
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -ffast-math -O3 -g
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -ffast-math -O3 -g -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
TARGET = $(TARGETDIR)/rpmalloc.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Optimized_Debug_Clang/rpmalloc
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -ffast-math -O3 -g
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -ffast-math -O3 -g -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
$(OBJDIR)/rpmalloc.o: ../../../../../src/Dependencies/rpmalloc/rpmalloc.cpp
	@echo $(notdir $<)
