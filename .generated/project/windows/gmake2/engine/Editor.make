...
INCLUDES += -I../../../../../src/Engine/Editor/include -I../../../../../src/Engine/Engine/include -I../../../../../src/Engine/Memory/include -I../../../../../src/Frameworks/Gaff/include -I../../../../../src/Dependencies/EASTL/include
FORCE_INCLUDE +=
...
TARGET = $(TARGETDIR)/Editor.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Debug/Editor
...
TARGET = $(TARGETDIR)/Editor.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Release/Editor
...
TARGET = $(TARGETDIR)/Editor.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Debug_Clang/Editor
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
...
TARGET = $(TARGETDIR)/Editor.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Release_Clang/Editor
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -DNDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
TARGET = $(TARGETDIR)/Editor.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Profile/Editor
...
TARGET = $(TARGETDIR)/Editor.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Profile_Clang/Editor
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -DNDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
TARGET = $(TARGETDIR)/Editor.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Optimized_Debug/Editor
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
TARGET = $(TARGETDIR)/Editor.lib
OBJDIR = ../../../../build/windows/gmake2/intermediate/x64/Optimized_Debug_Clang/Editor
DEFINES += -DUNICODE -D_UNICODE -DEA_COMPILER_NO_RTTI -D_DEBUG -DDEBUG -DWIN32 -D_WINDOWS -DWIN64
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -flto -Werror -ffast-math -O3 -g -Wall -Wextra -std=c++1z -fno-rtti
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64 -flto
...
OBJECTS += $(OBJDIR)/Shibboleth_EditorFileHandlerAttribute.o
OBJECTS += $(OBJDIR)/Shibboleth_EditorFileSelectedMessage.o
OBJECTS += $(OBJDIR)/Shibboleth_EditorWindowAttribute.o
...
$(OBJDIR)/Shibboleth_EditorFileHandlerAttribute.o: ../../../../../src/Engine/Editor/Shibboleth_EditorFileHandlerAttribute.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/Shibboleth_EditorFileSelectedMessage.o: ../../../../../src/Engine/Editor/Shibboleth_EditorFileSelectedMessage.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/Shibboleth_EditorWindowAttribute.o: ../../../../../src/Engine/Editor/Shibboleth_EditorWindowAttribute.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
