...
#define SDL_RWtell(s) gIO.tell(gIO.handle)
#define SDL_RWread(s,ptr,size,nmemb) gIO.read(gIO.handle, ptr,size,nmemb)
#define SDL_RWseek(s,offset,whence) gIO.seek(gIO.handle, offset, IL_ ## whence)
