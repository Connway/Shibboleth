...
NSString* const kAbortStr = @"Abort";
NSString* const kRetryStr = @"Retry";
NSString* const kIgnoreStr = @"Ignore";
NSString* const kTryStr = @"Try";
NSString* const kContinueStr = @"Continue";
...
void setButtons(NSAlert *alert, Buttons buttons) {
   switch (buttons) {
      ...
      case Buttons::AbortRetryIgnore:
         [alert addButtonWithTitle:kAbortStr];
         [alert addButtonWithTitle:kRetryStr];
         [alert addButtonWithTitle:kIgnoreStr];
         break;
      case Buttons::CancelTryContinue:
         [alert addButtonWithTitle:kCancelStr];
         [alert addButtonWithTitle:kTryStr];
         [alert addButtonWithTitle:kContinueStr];
         break;
      default:
         [alert addButtonWithTitle:kOkStr];
   }
